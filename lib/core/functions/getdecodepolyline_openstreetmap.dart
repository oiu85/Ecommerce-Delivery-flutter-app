...
/*
now listen am abd aging
look that is tow function
the first with duration , distance , and the PolyLIne 😑
 */
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonData['routes'].isNotEmpty) {
        ...
        print("✅ Distance: ${routeDistance! / 1000} km");
        print("✅ Duration: ${routeDuration! / 60} min");
...
/*
and this is the second for polyline only 😑
...
//     final response = await http.get(Uri.parse(url));
//
//     print("=============Response from Open Street Map  : ");
//     print(response.body);
//     if (response.statusCode == 200) {
//       final jsonData = jsonDecode(response.body);
//
