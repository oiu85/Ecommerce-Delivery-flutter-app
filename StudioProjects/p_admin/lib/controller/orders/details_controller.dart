...
class OrdersDetailsController extends GetxController{
  ...
  rejectOrder(String orderid , String userid,String reason)async{
      ...
      statusRequest = StatusRequest.loading;
      var response = await ordersDetailsData.rejectOrder(orderid, userid, reason);
      print("==============$userid");
      print("========================================Controller  $response");
      statusRequest = handlingData(response);
      if(StatusRequest.success==statusRequest){
        if(response['status']=="success"){
          notificationService.showSuccessNotification(title: "Done", message: "The order was rejected successfully");
        }
        else{
          statusRequest = StatusRequest.failure;
        }
